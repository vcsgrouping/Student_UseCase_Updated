...
public class AcademicYearController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AcademicYear getAcademicYear(@PathVariable("academicYear") String academicYear) {
        LOGGER.debug("Getting AcademicYear with id: {}" , academicYear);

        AcademicYear foundAcademicYear = academicYearService.getById(academicYear);
    ...
    @RequestMapping(value = "/{academicYear:.+}", method = RequestMethod.PUT)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AcademicYear editAcademicYear(@PathVariable("academicYear") String academicYear, @RequestBody AcademicYear academicYearInstance) {
        LOGGER.debug("Editing AcademicYear with id: {}" , academicYearInstance.getAcademicYear());

        academicYearInstance.setAcademicYear(academicYear);
    ...
    @RequestMapping(value = "/{academicYear:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AcademicYear patchAcademicYear(@PathVariable("academicYear") String academicYear, @RequestBody @MapTo(AcademicYear.class) Map<String, Object> academicYearInstancePatch) {
        LOGGER.debug("Partially updating AcademicYear with id: {}" , academicYear);

        AcademicYear academicYearInstance = academicYearService.partialUpdate(academicYear, academicYearInstancePatch);
    ...
    @RequestMapping(value = "/{academicYear:.+}", method = RequestMethod.DELETE)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAcademicYear(@PathVariable("academicYear") String academicYear) {
        LOGGER.debug("Deleting AcademicYear with id: {}" , academicYear);

        AcademicYear deletedAcademicYear = academicYearService.delete(academicYear);
	...
	@ApiOperation(value = "Returns the total count of AcademicYear instances matching the optional query (q) request param.")
    ...
    @RequestMapping(value="/{academicYear:.+}/academicses", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the academicses instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Academics> findAssociatedAcademicses(@PathVariable("academicYear") String academicYear, Pageable pageable) {

        LOGGER.debug("Fetching all associated academicses");
        return academicYearService.findAssociatedAcademicses(academicYear, pageable);
    }
