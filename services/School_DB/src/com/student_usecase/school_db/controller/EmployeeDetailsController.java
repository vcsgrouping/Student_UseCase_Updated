...
import com.student_usecase.school_db.service.EmployeeDetailsService;
...
public class EmployeeDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeeDetails getEmployeeDetails(@PathVariable("empId") Integer empId) {
        LOGGER.debug("Getting EmployeeDetails with id: {}" , empId);

        EmployeeDetails foundEmployeeDetails = employeeDetailsService.getById(empId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DownloadResponse getEmployeeDetailsBLOBContent(@PathVariable("empId") Integer empId, @PathVariable("fieldName") String fieldName, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, @RequestParam(value="download", defaultValue = "false") boolean download) {
        ...
        EmployeeDetails employeeDetails = employeeDetailsService.getById(empId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeeDetails editEmployeeDetails(@PathVariable("empId") Integer empId, @RequestBody EmployeeDetails employeeDetails) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeeDetails patchEmployeeDetails(@PathVariable("empId") Integer empId, @RequestBody @MapTo(EmployeeDetails.class) Map<String, Object> employeeDetailsPatch) {
        LOGGER.debug("Partially updating EmployeeDetails with id: {}" , empId);

        EmployeeDetails employeeDetails = employeeDetailsService.partialUpdate(empId, employeeDetailsPatch);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeeDetails editEmployeeDetails(@PathVariable("empId") Integer empId, MultipartHttpServletRequest multipartHttpServletRequest) {
        EmployeeDetails newEmployeeDetails = WMMultipartUtils.toObject(multipartHttpServletRequest, EmployeeDetails.class, "School_DB");
        newEmployeeDetails.setEmpId(empId);

        EmployeeDetails oldEmployeeDetails = employeeDetailsService.getById(empId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEmployeeDetails(@PathVariable("empId") Integer empId) {
        LOGGER.debug("Deleting EmployeeDetails with id: {}" , empId);

        EmployeeDetails deletedEmployeeDetails = employeeDetailsService.delete(empId);
	...
	@ApiOperation(value = "Returns the total count of EmployeeDetails instances matching the optional query (q) request param.")
    ...
    @RequestMapping(value="/{empId:.+}/employeeDetailsesForManagerId", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the employeeDetailsesForManagerId instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<EmployeeDetails> findAssociatedEmployeeDetailsesForManagerId(@PathVariable("empId") Integer empId, Pageable pageable) {

        LOGGER.debug("Fetching all associated employeeDetailsesForManagerId");
        return employeeDetailsService.findAssociatedEmployeeDetailsesForManagerId(empId, pageable);
    }
