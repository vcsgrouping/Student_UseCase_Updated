...
public class GradeDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public GradeDetails getGradeDetails(@PathVariable("gradeId") Integer gradeId) {
        LOGGER.debug("Getting GradeDetails with id: {}" , gradeId);

        GradeDetails foundGradeDetails = gradeDetailsService.getById(gradeId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public GradeDetails editGradeDetails(@PathVariable("gradeId") Integer gradeId, @RequestBody GradeDetails gradeDetails) {
        LOGGER.debug("Editing GradeDetails with id: {}" , gradeDetails.getGradeId());

        gradeDetails.setGradeId(gradeId);
    ...
    @RequestMapping(value = "/{gradeId:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public GradeDetails patchGradeDetails(@PathVariable("gradeId") Integer gradeId, @RequestBody @MapTo(GradeDetails.class) Map<String, Object> gradeDetailsPatch) {
        LOGGER.debug("Partially updating GradeDetails with id: {}" , gradeId);

        GradeDetails gradeDetails = gradeDetailsService.partialUpdate(gradeId, gradeDetailsPatch);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteGradeDetails(@PathVariable("gradeId") Integer gradeId) {
        LOGGER.debug("Deleting GradeDetails with id: {}" , gradeId);

        GradeDetails deletedGradeDetails = gradeDetailsService.delete(gradeId);
	...
	@ApiOperation(value = "Returns the total count of GradeDetails instances matching the optional query (q) request param.")
    ...
    @RequestMapping(value="/{gradeId:.+}/resultses", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the resultses instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Results> findAssociatedResultses(@PathVariable("gradeId") Integer gradeId, Pageable pageable) {

        LOGGER.debug("Fetching all associated resultses");
        return gradeDetailsService.findAssociatedResultses(gradeId, pageable);
    }
