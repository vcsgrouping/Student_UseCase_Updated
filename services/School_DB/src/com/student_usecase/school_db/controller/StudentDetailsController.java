...
public class StudentDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StudentDetails getStudentDetails(@PathVariable("studentId") Integer studentId) {
        LOGGER.debug("Getting StudentDetails with id: {}" , studentId);

        StudentDetails foundStudentDetails = studentDetailsService.getById(studentId);
    ...
    @RequestMapping(value = "/{studentId}/content/{fieldName}", method = RequestMethod.GET, produces="application/octet-stream")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public DownloadResponse getStudentDetailsBLOBContent(@PathVariable("studentId") Integer studentId, @PathVariable("fieldName") String fieldName, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, @RequestParam(value="download", defaultValue = "false") boolean download) {
        ...
        StudentDetails studentDetails = studentDetailsService.getById(studentId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StudentDetails editStudentDetails(@PathVariable("studentId") Integer studentId, @RequestBody StudentDetails studentDetails) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StudentDetails patchStudentDetails(@PathVariable("studentId") Integer studentId, @RequestBody @MapTo(StudentDetails.class) Map<String, Object> studentDetailsPatch) {
        LOGGER.debug("Partially updating StudentDetails with id: {}" , studentId);

        StudentDetails studentDetails = studentDetailsService.partialUpdate(studentId, studentDetailsPatch);
    ...
    @RequestMapping(value = "/{studentId:.+}", method = RequestMethod.POST, consumes = {"multipart/form-data"})
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StudentDetails editStudentDetails(@PathVariable("studentId") Integer studentId, MultipartHttpServletRequest multipartHttpServletRequest) {
        StudentDetails newStudentDetails = WMMultipartUtils.toObject(multipartHttpServletRequest, StudentDetails.class, "School_DB");
        newStudentDetails.setStudentId(studentId);

        StudentDetails oldStudentDetails = studentDetailsService.getById(studentId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteStudentDetails(@PathVariable("studentId") Integer studentId) {
        LOGGER.debug("Deleting StudentDetails with id: {}" , studentId);

        StudentDetails deletedStudentDetails = studentDetailsService.delete(studentId);
    ...
    @RequestMapping(value="/{studentId:.+}/resultses", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the resultses instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Results> findAssociatedResultses(@PathVariable("studentId") Integer studentId, Pageable pageable) {

        LOGGER.debug("Fetching all associated resultses");
        return studentDetailsService.findAssociatedResultses(studentId, pageable);
    }

    @RequestMapping(value="/{studentId:.+}/studentAcademicses", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the studentAcademicses instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<StudentAcademics> findAssociatedStudentAcademicses(@PathVariable("studentId") Integer studentId, Pageable pageable) {

        LOGGER.debug("Fetching all associated studentAcademicses");
        return studentDetailsService.findAssociatedStudentAcademicses(studentId, pageable);
    }
