...
public class SubjectDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public SubjectDetails getSubjectDetails(@PathVariable("subjectId") Integer subjectId) {
        LOGGER.debug("Getting SubjectDetails with id: {}" , subjectId);

        SubjectDetails foundSubjectDetails = subjectDetailsService.getById(subjectId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public SubjectDetails editSubjectDetails(@PathVariable("subjectId") Integer subjectId, @RequestBody SubjectDetails subjectDetails) {
    ...
    @RequestMapping(value = "/{subjectId:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public SubjectDetails patchSubjectDetails(@PathVariable("subjectId") Integer subjectId, @RequestBody @MapTo(SubjectDetails.class) Map<String, Object> subjectDetailsPatch) {
        LOGGER.debug("Partially updating SubjectDetails with id: {}" , subjectId);

        SubjectDetails subjectDetails = subjectDetailsService.partialUpdate(subjectId, subjectDetailsPatch);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteSubjectDetails(@PathVariable("subjectId") Integer subjectId) {
        LOGGER.debug("Deleting SubjectDetails with id: {}" , subjectId);

        SubjectDetails deletedSubjectDetails = subjectDetailsService.delete(subjectId);
	...
	@ApiOperation(value = "Returns the total count of SubjectDetails instances matching the optional query (q) request param.")
    ...
    @RequestMapping(value="/{subjectId:.+}/academicSubjectses", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the academicSubjectses instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<AcademicSubjects> findAssociatedAcademicSubjectses(@PathVariable("subjectId") Integer subjectId, Pageable pageable) {

        LOGGER.debug("Fetching all associated academicSubjectses");
        return subjectDetailsService.findAssociatedAcademicSubjectses(subjectId, pageable);
    }
