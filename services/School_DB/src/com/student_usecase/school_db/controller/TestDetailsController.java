...
public class TestDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TestDetails getTestDetails(@PathVariable("testId") Integer testId) {
        LOGGER.debug("Getting TestDetails with id: {}" , testId);

        TestDetails foundTestDetails = testDetailsService.getById(testId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TestDetails editTestDetails(@PathVariable("testId") Integer testId, @RequestBody TestDetails testDetails) {
    ...
    @RequestMapping(value = "/{testId:.+}", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public TestDetails patchTestDetails(@PathVariable("testId") Integer testId, @RequestBody @MapTo(TestDetails.class) Map<String, Object> testDetailsPatch) {
        LOGGER.debug("Partially updating TestDetails with id: {}" , testId);

        TestDetails testDetails = testDetailsService.partialUpdate(testId, testDetailsPatch);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteTestDetails(@PathVariable("testId") Integer testId) {
        LOGGER.debug("Deleting TestDetails with id: {}" , testId);

        TestDetails deletedTestDetails = testDetailsService.delete(testId);
    ...
    @RequestMapping(value="/{testId:.+}/academicTestSubjectses", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the academicTestSubjectses instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<AcademicTestSubjects> findAssociatedAcademicTestSubjectses(@PathVariable("testId") Integer testId, Pageable pageable) {

        LOGGER.debug("Fetching all associated academicTestSubjectses");
        return testDetailsService.findAssociatedAcademicTestSubjectses(testId, pageable);
    }
