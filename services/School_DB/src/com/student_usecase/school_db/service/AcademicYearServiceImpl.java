...
@Validated
@EntityService(entityClass = AcademicYear.class, serviceId = "School_DB")
public class AcademicYearServiceImpl implements AcademicYearService {
    ...
    public AcademicYear partialUpdate(String academicyearId, Map<String, Object>academicYearInstancePatch) {
        ...
        try {
            ObjectReader academicYearInstanceReader = this.objectMapper.reader().forType(AcademicYear.class).withValueToUpdate(academicYearInstance);
