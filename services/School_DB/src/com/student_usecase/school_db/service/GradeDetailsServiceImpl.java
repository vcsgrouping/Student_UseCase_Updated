...
@Validated
@EntityService(entityClass = GradeDetails.class, serviceId = "School_DB")
public class GradeDetailsServiceImpl implements GradeDetailsService {
    ...
    public GradeDetails partialUpdate(Integer gradedetailsId, Map<String, Object>gradeDetailsPatch) {
        ...
        try {
            ObjectReader gradeDetailsReader = this.objectMapper.reader().forType(GradeDetails.class).withValueToUpdate(gradeDetails);
