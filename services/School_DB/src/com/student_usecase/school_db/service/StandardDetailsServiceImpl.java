...
public class StandardDetailsServiceImpl implements StandardDetailsService {
    ...
    public StandardDetails getByStandardCode(String standardCode) {
        ...
        StandardDetails standardDetails = this.wmGenericDao.findByUniqueKey(standardCodeMap);

        if (standardDetails == null){
            LOGGER.debug("No StandardDetails found with given unique key values: {}", standardCodeMap);
            throw new EntityNotFoundException(String.valueOf(standardCodeMap));
        }
