...
public class StudentAcademicsServiceImpl implements StudentAcademicsService {
    ...
    public StudentAcademics getByRollNumber(int rollNumber) {
        ...
        StudentAcademics studentAcademics = this.wmGenericDao.findByUniqueKey(rollNumberMap);

        if (studentAcademics == null){
            LOGGER.debug("No StudentAcademics found with given unique key values: {}", rollNumberMap);
            throw new EntityNotFoundException(String.valueOf(rollNumberMap));
        }
	...
	public StudentAcademics update(StudentAcademics studentAcademics) throws EntityNotFoundException {
        ...
        studentacademicsId.setStandardId(studentAcademics.getStandardId());
