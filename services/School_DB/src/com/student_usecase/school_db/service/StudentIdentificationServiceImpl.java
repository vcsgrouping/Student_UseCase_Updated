...
@Validated
@EntityService(entityClass = StudentIdentification.class, serviceId = "School_DB")
public class StudentIdentificationServiceImpl implements StudentIdentificationService {
    ...
    public StudentIdentification partialUpdate(Integer studentidentificationId, Map<String, Object>studentIdentificationPatch) {
        ...
        try {
            ObjectReader studentIdentificationReader = this.objectMapper.reader().forType(StudentIdentification.class).withValueToUpdate(studentIdentification);
