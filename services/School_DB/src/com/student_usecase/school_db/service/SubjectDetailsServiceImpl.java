...
@Validated
@EntityService(entityClass = SubjectDetails.class, serviceId = "School_DB")
public class SubjectDetailsServiceImpl implements SubjectDetailsService {
    ...
    public SubjectDetails partialUpdate(Integer subjectdetailsId, Map<String, Object>subjectDetailsPatch) {
        ...
        try {
            ObjectReader subjectDetailsReader = this.objectMapper.reader().forType(SubjectDetails.class).withValueToUpdate(subjectDetails);
