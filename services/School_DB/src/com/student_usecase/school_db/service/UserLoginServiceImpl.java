...
@Validated
@EntityService(entityClass = UserLogin.class, serviceId = "School_DB")
public class UserLoginServiceImpl implements UserLoginService {
    ...
    public UserLogin delete(Integer userloginId) {
        ...
        EmployeeDetails employeeDetailsEntity = deleted.getEmployeeDetails();
        if(employeeDetailsEntity!=null) {
            employeeDetailsEntity.setUserLogin(null);
        }
