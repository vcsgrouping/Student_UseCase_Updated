...
import com.student_usecase.school_db.ViewResults;
import com.student_usecase.school_db.ViewResultsId;
...
public class ViewResultsServiceImpl implements ViewResultsService {
	...
	public ViewResults create(ViewResults viewResults) {
        ...
        return viewResultsCreated;
    }

	@Transactional(readOnly = true, value = "School_DBTransactionManager")
	@Override
	public ViewResults getById(ViewResultsId viewresultsId) throws EntityNotFoundException {
        LOGGER.debug("Finding ViewResults by id: {}", viewresultsId);
        ViewResults viewResults = this.wmGenericDao.findById(viewresultsId);
        if (viewResults == null){
	...
	@Override
	public ViewResults update(ViewResults viewResults) throws EntityNotFoundException {
    ...
    @Transactional(value = "School_DBTransactionManager")
	@Override
	public ViewResults delete(ViewResultsId viewresultsId) throws EntityNotFoundException {
