...
@Validated
@EntityService(entityClass = ViewResults.class, serviceId = "School_DB")
public class ViewResultsServiceImpl implements ViewResultsService {
    ...
    public ViewResults partialUpdate(ViewResultsId viewresultsId, Map<String, Object>viewResultsPatch) {
        ...
        try {
            ObjectReader viewResultsReader = this.objectMapper.reader().forType(ViewResults.class).withValueToUpdate(viewResults);
