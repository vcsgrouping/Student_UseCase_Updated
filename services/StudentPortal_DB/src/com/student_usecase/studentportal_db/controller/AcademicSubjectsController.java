...
public class AcademicSubjectsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AcademicSubjects getAcademicSubjects(@RequestParam("subjectName") String subjectName, @RequestParam("academicYear") Date academicYear, @RequestParam("subjectTeacher") String subjectTeacher, @RequestParam("standard") String standard) {

        AcademicSubjectsId academicsubjectsId = new AcademicSubjectsId();
        academicsubjectsId.setSubjectName(subjectName);
        academicsubjectsId.setAcademicYear(academicYear);
        academicsubjectsId.setSubjectTeacher(subjectTeacher);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AcademicSubjects editAcademicSubjects(@RequestParam("subjectName") String subjectName, @RequestParam("academicYear") Date academicYear, @RequestParam("subjectTeacher") String subjectTeacher, @RequestParam("standard") String standard, @RequestBody AcademicSubjects academicSubjects) {

        academicSubjects.setSubjectName(subjectName);
        academicSubjects.setAcademicYear(academicYear);
        academicSubjects.setSubjectTeacher(subjectTeacher);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AcademicSubjects patchAcademicSubjects(@RequestParam("subjectName") String subjectName, @RequestParam("academicYear") Date academicYear, @RequestParam("subjectTeacher") String subjectTeacher, @RequestParam("standard") String standard, @RequestBody @MapTo(AcademicSubjects.class) Map<String, Object> academicSubjectsPatch) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAcademicSubjects(@RequestParam("subjectName") String subjectName, @RequestParam("academicYear") Date academicYear, @RequestParam("subjectTeacher") String subjectTeacher, @RequestParam("standard") String standard) {
	...
	@ApiOperation(value = "Returns the total count of AcademicSubjects instances matching the optional query (q) request param.")
