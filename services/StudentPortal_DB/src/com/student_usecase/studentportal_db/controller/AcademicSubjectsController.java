...
public class AcademicSubjectsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AcademicSubjects getAcademicSubjects(@RequestParam("academicYear") Date academicYear,@RequestParam("standard") String standard,@RequestParam("subjectName") String subjectName,@RequestParam("subjectTeacher") String subjectTeacher) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public AcademicSubjects editAcademicSubjects(@RequestParam("academicYear") Date academicYear,@RequestParam("standard") String standard,@RequestParam("subjectName") String subjectName,@RequestParam("subjectTeacher") String subjectTeacher, @RequestBody AcademicSubjects academicSubjects) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAcademicSubjects(@RequestParam("academicYear") Date academicYear,@RequestParam("standard") String standard,@RequestParam("subjectName") String subjectName,@RequestParam("subjectTeacher") String subjectTeacher) throws EntityNotFoundException {
