...
public class AcademicsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Academics getAcademics(@RequestParam("classroom") String classroom, @RequestParam("academicYear") Date academicYear, @RequestParam("classteacher") String classteacher, @RequestParam("standard") String standard) {

        AcademicsId academicsId = new AcademicsId();
        academicsId.setClassroom(classroom);
        academicsId.setAcademicYear(academicYear);
        academicsId.setClassteacher(classteacher);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Academics editAcademics(@RequestParam("classroom") String classroom, @RequestParam("academicYear") Date academicYear, @RequestParam("classteacher") String classteacher, @RequestParam("standard") String standard, @RequestBody Academics academics) {

        academics.setClassroom(classroom);
        academics.setAcademicYear(academicYear);
        academics.setClassteacher(classteacher);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Academics patchAcademics(@RequestParam("classroom") String classroom, @RequestParam("academicYear") Date academicYear, @RequestParam("classteacher") String classteacher, @RequestParam("standard") String standard, @RequestBody @MapTo(Academics.class) Map<String, Object> academicsPatch) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAcademics(@RequestParam("classroom") String classroom, @RequestParam("academicYear") Date academicYear, @RequestParam("classteacher") String classteacher, @RequestParam("standard") String standard) {
	...
	@ApiOperation(value = "Returns the total count of Academics instances matching the optional query (q) request param.")
