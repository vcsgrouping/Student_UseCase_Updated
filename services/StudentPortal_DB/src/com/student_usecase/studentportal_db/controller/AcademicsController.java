...
public class AcademicsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Academics getAcademics(@RequestParam("academicYear") Date academicYear,@RequestParam("classroom") String classroom,@RequestParam("classteacher") String classteacher,@RequestParam("standard") String standard) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Academics editAcademics(@RequestParam("academicYear") Date academicYear,@RequestParam("classroom") String classroom,@RequestParam("classteacher") String classteacher,@RequestParam("standard") String standard, @RequestBody Academics academics) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteAcademics(@RequestParam("academicYear") Date academicYear,@RequestParam("classroom") String classroom,@RequestParam("classteacher") String classteacher,@RequestParam("standard") String standard) throws EntityNotFoundException {
