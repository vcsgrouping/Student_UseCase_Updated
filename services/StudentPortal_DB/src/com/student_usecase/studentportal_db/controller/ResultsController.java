...
public class ResultsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Results getResults(@RequestParam("rollnumber") Integer rollnumber, @RequestParam("academicYear") Date academicYear, @RequestParam("grade") String grade, @RequestParam("marks") Short marks, @RequestParam("standard") String standard) {

        ResultsId resultsId = new ResultsId();
        resultsId.setRollnumber(rollnumber);
        resultsId.setAcademicYear(academicYear);
        resultsId.setGrade(grade);
        resultsId.setMarks(marks);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Results editResults(@RequestParam("rollnumber") Integer rollnumber, @RequestParam("academicYear") Date academicYear, @RequestParam("grade") String grade, @RequestParam("marks") Short marks, @RequestParam("standard") String standard, @RequestBody Results results) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Results patchResults(@RequestParam("rollnumber") Integer rollnumber, @RequestParam("academicYear") Date academicYear, @RequestParam("grade") String grade, @RequestParam("marks") Short marks, @RequestParam("standard") String standard, @RequestBody @MapTo(Results.class) Map<String, Object> resultsPatch) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteResults(@RequestParam("rollnumber") Integer rollnumber, @RequestParam("academicYear") Date academicYear, @RequestParam("grade") String grade, @RequestParam("marks") Short marks, @RequestParam("standard") String standard) {
	...
	@ApiOperation(value = "Returns the total count of Results instances matching the optional query (q) request param.")
