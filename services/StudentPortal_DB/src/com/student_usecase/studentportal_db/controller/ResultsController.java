...
@ApiOperation(value = "Returns the Results instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Results editResults(@RequestParam("academicYear") Date academicYear,@RequestParam("grade") String grade,@RequestParam("marks") Short marks,@RequestParam("rollnumber") Integer rollnumber,@RequestParam("standard") String standard, @RequestBody Results results) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteResults(@RequestParam("academicYear") Date academicYear,@RequestParam("grade") String grade,@RequestParam("marks") Short marks,@RequestParam("rollnumber") Integer rollnumber,@RequestParam("standard") String standard) throws EntityNotFoundException {
