...
public class StandardDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StandardDetails getStandardDetails(@RequestParam("standardName") String standardName, @RequestParam("standardId") String standardId) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StandardDetails editStandardDetails(@RequestParam("standardName") String standardName, @RequestParam("standardId") String standardId, @RequestBody StandardDetails standardDetails) {
	...
	@ApiOperation(value = "Partially updates the  StandardDetails instance associated with the given composite-id.")
	@RequestMapping(value = "/composite-id", method = RequestMethod.PATCH)
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StandardDetails patchStandardDetails(@RequestParam("standardName") String standardName, @RequestParam("standardId") String standardId, @RequestBody @MapTo(StandardDetails.class) Map<String, Object> standardDetailsPatch) {

        StandardDetailsId standarddetailsId = new StandardDetailsId();
        standarddetailsId.setStandardName(standardName);
        standarddetailsId.setStandardId(standardId);
        LOGGER.debug("Partially updating StandardDetails with id: {}" , standarddetailsId);

        StandardDetails standardDetails = standardDetailsService.partialUpdate(standarddetailsId, standardDetailsPatch);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteStandardDetails(@RequestParam("standardName") String standardName, @RequestParam("standardId") String standardId) {
