...
@ApiOperation(value = "Returns the StudentAcademics instance associated with the given composite-id.")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StudentAcademics editStudentAcademics(@RequestParam("academicYear") Date academicYear,@RequestParam("rollnumber") Integer rollnumber,@RequestParam("standard") String standard,@RequestParam("studentId") Integer studentId, @RequestBody StudentAcademics studentAcademics) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteStudentAcademics(@RequestParam("academicYear") Date academicYear,@RequestParam("rollnumber") Integer rollnumber,@RequestParam("standard") String standard,@RequestParam("studentId") Integer studentId) throws EntityNotFoundException {
