...
public class StudentAcademicsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StudentAcademics getStudentAcademics(@RequestParam("rollnumber") Integer rollnumber, @RequestParam("academicYear") Date academicYear, @RequestParam("standard") String standard, @RequestParam("studentId") Integer studentId) {

        StudentAcademicsId studentacademicsId = new StudentAcademicsId();
        studentacademicsId.setRollnumber(rollnumber);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StudentAcademics editStudentAcademics(@RequestParam("rollnumber") Integer rollnumber, @RequestParam("academicYear") Date academicYear, @RequestParam("standard") String standard, @RequestParam("studentId") Integer studentId, @RequestBody StudentAcademics studentAcademics) {

        studentAcademics.setRollnumber(rollnumber);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public StudentAcademics patchStudentAcademics(@RequestParam("rollnumber") Integer rollnumber, @RequestParam("academicYear") Date academicYear, @RequestParam("standard") String standard, @RequestParam("studentId") Integer studentId, @RequestBody @MapTo(StudentAcademics.class) Map<String, Object> studentAcademicsPatch) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteStudentAcademics(@RequestParam("rollnumber") Integer rollnumber, @RequestParam("academicYear") Date academicYear, @RequestParam("standard") String standard, @RequestParam("studentId") Integer studentId) {
	...
	@ApiOperation(value = "Returns the total count of StudentAcademics instances matching the optional query (q) request param.")
