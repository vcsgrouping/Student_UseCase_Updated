...
public interface StandardDetailsService {
     ...
     */
    StandardDetails getById(StandardDetailsId standarddetailsId);
     ...
     * @return StandardDetails associated with the given standarddetailsId.
     */
    StandardDetails findById(StandardDetailsId standarddetailsId);
     ...
     */
    List<StandardDetails> findByMultipleIds(List<StandardDetailsId> standarddetailsIds, boolean orderedReturn);
     ...
     * @throws EntityNotFoundException if no StandardDetails is found with given input.
     */
    StandardDetails partialUpdate(StandardDetailsId standarddetailsId, Map<String, Object> standardDetailsPatch);
     ...
     */
    StandardDetails delete(StandardDetailsId standarddetailsId);
