...
public interface TestDetailsService {
     ...
     */
    TestDetails getById(TestDetailsId testdetailsId);
     ...
     */
    List<TestDetails> findByMultipleIds(List<TestDetailsId> testdetailsIds, boolean orderedReturn);
     ...
     * @throws EntityNotFoundException if no TestDetails is found with given input.
     */
    TestDetails partialUpdate(TestDetailsId testdetailsId, Map<String, Object> testDetailsPatch);
     ...
     */
    TestDetails delete(TestDetailsId testdetailsId);
