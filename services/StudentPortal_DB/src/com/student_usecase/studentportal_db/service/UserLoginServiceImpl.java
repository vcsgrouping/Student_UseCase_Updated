...
@Validated
@EntityService(entityClass = UserLogin.class, serviceId = "StudentPortal_DB")
public class UserLoginServiceImpl implements UserLoginService {
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service StudentPortal_DB for table UserLogin to {} format", options.getExportType());
